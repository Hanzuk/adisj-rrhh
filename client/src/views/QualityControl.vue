          ...
          <div class="column is-full">
            <div class="box">
              ...
              <b-message type="is-info">
                Muestra las calificaciones asignadas a los choferes en base a la calidad del servicio que brindaron
                según los clientes que completaron el formulario.
              </b-message>
              <b-table
                :data="quality.rating"
                :paginated="true"
                ...
                <template slot="empty">
                  <section class="section">
                    <div class="content has-text-grey has-text-centered">
                      ...
                      <p>
                        Tienes que seleccionar un chofer arriba para ver los votos que recibió por parte de los
                        clientes.
                      </p>
                    </div>
                  </section>
