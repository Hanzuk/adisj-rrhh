...
-- Inserts para los tipo de telefonos
INSERT INTO tipo_telefonos (nombre) VALUES('Celular');
INSERT INTO tipo_telefonos (nombre) VALUES('Casa');

-- Inserts para los tipos de empleados
INSERT INTO tipo_empleados (cargo) VALUES('Administrador');
INSERT INTO tipo_empleados (cargo) VALUES('Secretario');
INSERT INTO tipo_empleados (cargo) VALUES('Chofer');
INSERT INTO tipo_empleados (cargo) VALUES('Temporal');

-- Inserts para los diferentes estados
INSERT INTO estados (estado) VALUES('Pendiente');
INSERT INTO estados (estado) VALUES('Aprobado');
...
INSERT INTO cantones (codigo, codigo_provincia, nombre) VALUES
 (101, 1, 'San José'),
 (102, 1, 'Escazú'),
 (103, 1, 'Desamparados'),
 (104, 1, 'Puriscal'),
...
INSERT INTO distritos (codigo, codigo_canton, nombre) VALUES
 (10101, 101, 'Carmen'),
 (10102, 101, 'Merced'),
 (10103, 101, 'Hospital'),
 (10104, 101, 'Catedral'),
...
VALUES ('140578950', 'Leonidas', 'Quesada', 'Jonhs', '1980-01-30', 'admin01@gmail.com', '$2a$10$IhbfjLFEflE0fWBd1nSKLOCDNlZR1ijCI/iToWJKDte8Qj6v3IAJq', 1, 1);

INSERT INTO telefonos (id_empleado, numero, activo, tipo_telefono)
VALUES (1, '89008760', 1, 1);
...
VALUES ('285985783', 'Dimitri', 'Diaz', 'Salas', '1985-10-09', 'dimitri@hotmail.com', '$2a$10$IhbfjLFEflE0fWBd1nSKLOCDNlZR1ijCI/iToWJKDte8Qj6v3IAJq', 1, 3, '2010-02-23');

INSERT INTO telefonos (id_empleado, numero, activo, tipo_telefono)
VALUES (2, '78452568', 1, 1);

INSERT INTO direcciones (id_empleado, codigo_provincia, codigo_canton, codigo_distrito, direccion, activo)
VALUES (2, 1, 104, 10403, '200 mts norte de la catedral', 1);
